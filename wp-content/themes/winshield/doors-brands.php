		...
		<div class="auto-container">
			...
			<div class="window-nav-outer">
				<ul class="window-nav clearfix">
					...
					<li class="active"><a href="/winsheald/doors-brand/">Doors Brands</a></li>
					...
					<div class="inner-column">
						...
						<div class="masonry-items-container row clearfix">
							...
							<div class="brand-block masonry-item col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="image">
										<img src="<?php bloginfo('template_directory');?>/images/resource/brand-1.png" alt="" />
									</div>
									<h3>Unilux</h3>
							...
							<div class="brand-block masonry-item col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="image">
										<img src="<?php bloginfo('template_directory');?>/images/resource/brand-2.png" alt="" />
									</div>
									<h3>Nasdaq</h3>
							...
							<div class="brand-block masonry-item col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="image">
										<img src="<?php bloginfo('template_directory');?>/images/resource/brand-3.png" alt="" />
									</div>
									<h3>Compass</h3>
							...
							<div class="brand-block masonry-item col-lg-6 col-md-6 col-sm-12">
								<div class="inner-box">
									<div class="image">
										<img src="<?php bloginfo('template_directory');?>/images/resource/brand-4.png" alt="" />
									</div>
									<h3>Boomset</h3>
